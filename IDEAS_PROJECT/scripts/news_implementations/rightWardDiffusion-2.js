// RightWardDiffusion Class
class RightWardDiffusion{ // RightWardDiffusion class
     ...
     getRightWardDiffusion(){
        
         let newDiffusedText='';
        let rightWardDiffused;
        ...
        while(iter>0){
            ...
            rightWardDiffused = this.message;
        ...
        getFirstOrbit(){
          ...
          return this.getRightWardDiffusion();
     }
    ...
    getLastOrbit(){
      ...
      if(functionDiff=="N" || functionDiff=="NR"){
        if (functionDiff=="N"){
            if(msgLen%2==0){
                let rightWardReversedDiff = new RightWardReversedDiffusion(this.message, 'S', this._PalestineIndex);
                lastOrbit = rightWardReversedDiff.getFirstOrbit();
            }else{
                let rightWardReversedDiff = new RightWardReversedDiffusion(this.message, 'NR', this._PalestineIndex);
                lastOrbit = rightWardReversedDiff.getFirstOrbit();
            }
        } else if(functionDiff=="NR"&&msgLen%2==1){
            let rightWardReversedDiff = new RightWardReversedDiffusion(this.message, 'N', this._PalestineIndex);
            lastOrbit = rightWardReversedDiff.getFirstOrbit();
        }
      }else if(functionDiff=="E" || functionDiff=="ER"){
        if (functionDiff=="E"){
            if(msgLen%2==0){
                let rightWardReversedDiff = new RightWardReversedDiffusion(this.message, 'W', this._PalestineIndex);
                lastOrbit = rightWardReversedDiff.getFirstOrbit();
            }else{
                let rightWardReversedDiff = new RightWardReversedDiffusion(this.message, 'ER', this._PalestineIndex);
                lastOrbit = rightWardReversedDiff.getFirstOrbit();
            }
        }else if (functionDiff=="ER"&&msgLen%2==1){
            let rightWardReversedDiff = new RightWardReversedDiffusion(this.message, 'E', this._PalestineIndex);
            lastOrbit = rightWardReversedDiff.getFirstOrbit();
        }
        ...
        if (functionDiff=="W"){
            if(msgLen%2==0){
                ...
                let rightWardReversedDiff = new RightWardReversedDiffusion(this.message, 'WR', this._PalestineIndex);
                lastOrbit = rightWardReversedDiff.getFirstOrbit();
            }
        ...
        if (functionDiff=="S"){
            if(msgLen%2==0){
                ...
                let rightWardReversedDiff = new RightWardReversedDiffusion(this.message, 'SR', this._PalestineIndex);
                lastOrbit = rightWardReversedDiff.getFirstOrbit();
            }
    ...
    // return orbit at specified index using one of NEWS function
     getOrbitAt(index){
        ...
        let i = 1;
        while(true) {
            let orbitsGen = this.getRightWardDiffusion();
            if(i==index) {
                return orbitsGen;
            }
     ...
     printOrbitsInRange(range){
        ...
        let i = 1;
        while(range>0){
            diffusedText = this.getRightWardDiffusion();
