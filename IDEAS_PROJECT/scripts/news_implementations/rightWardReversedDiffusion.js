// RightWardReversedDiffusion Class
class RightWardReversedDiffusion{ // RightWardReversedDiffusion class
        ...
        getRightWardReversedDiffusion(){
       
        let newDiffusedText = '';
        let rightWardReversedDiffused;
        ...
        while(iter>0){
           ...
           rightWardReversedDiffused = this.message;
    ...
    getFirstOrbit(){
          ...
          return this.getRightWardReversedDiffusion();
     }
    ...
    getLastOrbit(){
      ...
      if(functionDiff=="N" || functionDiff=="NR"){
        if (functionDiff=="N"){
            if(msgLen%2==0){
                let rightWardDiff = new RightWardDiffusion(this.message, 'S', this._PalestineIndex);
                lastOrbit = rightWardDiff.getFirstOrbit();
            }else{
                let rightWardDiff = new RightWardDiffusion(this.message, 'NR', this._PalestineIndex);
                lastOrbit = rightWardDiff.getFirstOrbit();
            }
        } else if(functionDiff=="NR"&&msgLen%2==1){
            let rightWardDiff = new RightWardDiffusion(this.message, 'N', this._PalestineIndex);
            lastOrbit = rightWardDiff.getFirstOrbit();
        }
      }else if(functionDiff=="E" || functionDiff=="ER"){
        if (functionDiff=="E"){
            if(msgLen%2==0){
                let rightWardDiff = new RightWardDiffusion(this.message, 'W', this._PalestineIndex);
                lastOrbit = rightWardDiff.getFirstOrbit();
            }else{
                let rightWardDiff = new RightWardDiffusion(this.message, 'ER', this._PalestineIndex);
                lastOrbit = rightWardDiff.getFirstOrbit();
            }
        }else if (functionDiff=="ER"&&msgLen%2==1){
            let rightWardDiff = new RightWardDiffusion(this.message, 'E', this._PalestineIndex);
            lastOrbit = rightWardDiff.getFirstOrbit();
        }
        ...
        if (functionDiff=="W"){
            if(msgLen%2==0){
                ...
                let rightWardDiff = new RightWardDiffusion(this.message, 'WR', this._PalestineIndex);
                lastOrbit = rightWardDiff.getFirstOrbit();
            }
        ...
        if (functionDiff=="S"){
            if(msgLen%2==0){
                ...
                let rightWardDiff = new RightWardDiffusion(this.message, 'SR', this._PalestineIndex);
                lastOrbit = rightWardDiff.getFirstOrbit();
            }
    ...
    // return orbit at specified index using one of NEWS function
     getOrbitAt(index){
        ...
        let i = 1;
        while(true) {
            let orbitsGen = this.getRightWardReversedDiffusion();
            if(i==index) {
                return orbitsGen;
            }
     ...
     printOrbitsInRange(range){
        ...
        let i = 1;
        while(range>0){
            diffusedText = this.getRightWardReversedDiffusion();
    ...
    }// class RightWardReversedDiffusion
