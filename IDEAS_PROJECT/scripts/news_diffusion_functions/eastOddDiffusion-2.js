class EastOddDiffusion {
    ...
    getFirstOrbit() {
        ...
        return this.getEastOddDiffusion();
    }// first orbit
    ...
    getOrbitAt(orbitIndex) {
        ...
        let i = 1;
        while (true) {
            let orbit = this.getEastOddDiffusion();
    ...
    printOrbitsInRange(range) {
        ...
        let i = 1;
        while (range > 0) {
            orbitsInRange = this.getEastOddDiffusion();
    ...
    printAllOrbits() {
        this.initText = this.text;
        let firstOrbit = this.getEastOddDiffusion();
        ...
        let t = 2;
        while (true) {
            let orbitGen = this.getEastOddDiffusion();
