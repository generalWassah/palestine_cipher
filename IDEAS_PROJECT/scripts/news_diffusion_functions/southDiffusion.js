class SouthDiffusion {
    ...
    getSouthSum() {
        ...
        let textTsum = (textPsum + textNsum) % this.modulo;
        return textTsum;
    }//getSouthSum

    // South diffusion function
    getSouthDiffusion() {
        ...
        let southDiffusedText = dChar.join("");
        return southDiffusedText;
    }// getSouthDiffusion

    // get the first orbit of the iterated sequence
    getFirstOrbit() {
        this.initText = this.text;
        return this.getSouthDiffusion();
    }// first orbit
    ...
    printOrbitsInRange(range) {
        ...
        let i = 1;
        while (range > 0) {
            orbitsInRange = this.getSouthDiffusion(_PalestineIndex);
    ...
    printAllOrbits() {
        ...
        let firstOrbit = "";
        let firstOrbitOdd = "";
        firstOrbit = this.getSouthDiffusion();
        ...
        let t = 2;
        while (true) {
            orbitGen = this.getSouthDiffusion();
    ...
    printCollisions() {
        ...
        if (this.initText.length % 2 === 1&&this.initText!=="") {
            ...
            let firstOrbit = this.getSouthDiffusion();
            let sz;
        if(this.isLetter(this.initText.charAt(0))){
