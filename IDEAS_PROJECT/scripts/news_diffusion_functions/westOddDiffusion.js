...
class WestOddDiffusion {
    ...
    getWestOddDiffusion() {
        ...
        // here the original diffused text is recovered
    ...
    getFirstOrbit() {
        ...
        return this.getWestOddDiffusion();
    }// first orbit
    ...
    getOrbitAt(orbitIndex) {
        ...
        let i = 1;
        while (true) {
            let orbit = this.getWestOddDiffusion(_PalestineIndex);
    ...
    printOrbitsInRange(range) {
        ...
        let i = 1;
        while (range > 0) {
            orbitsInRange = this.getWestOddDiffusion();
    ...
    printAllOrbits() {
        this.initText = this.text;
        let firstOrbit = this.getWestOddDiffusion();
        ...
        let t = 2;
        while (true) {
            let orbitGen = this.getWestOddDiffusion();
